      ...
      while True:
            ...
            if faces > 0:
                  ...
                  if roi.any():
                        ...
                        print (label)
                        cv.putText(frameClone, label, (25, 25), cv.FONT_HERSHEY_SIMPLEX, 1.5, (0, 0, 255), 3)
            showTime = time.time()            
            ...
            prepareDuration = '%.2f' % (prepareTime - startTime)
            ...
            with open('/home/pi/Documents/tfEmotion/Durations.txt', 'a') as the_file:
                    the_file.write('capture and prepare: ' + prepareDuration + 's\n'
                                    + 'Face detection: ' + processDuration + 's\n'
                                    + 'Emotion detection: ' + showDuration + 's\n'
                                    + 'Whole Loop: ' + loopDuration + 's\n\n')
